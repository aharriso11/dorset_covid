...
sheet_path <- "https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1060253/variants-of-concern-technical-briefing-38-data-england-11-March-2022.ods"

# set plot title
plot_subtitle <- "Variant prevalence for all England available sequenced cases from 1 February 2021 as of 8 March 2022"

# set plot caption
plot_caption <- "Data from UK Health Security Agency technical briefing 38 (gateway number GOV-11613)."

# set file name
file_name <- "devel/techreport38.ods"
